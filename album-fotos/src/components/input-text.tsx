...
export const inputTextWrapperVariants = tv({
    base: `
        ...
        focus:border-border-border-active bg-transparent
...
export const inpuTextIconVariants = tv({
...
export default function InputText({
    ...
    <div className={inputTextContainerVariants({className})}>
        <div className={inputTextWrapperVariants({size, disabled})}>
            {icon && <Icon svg={icon} className={inpuTextIconVariants({size})}/>}
            <input 
